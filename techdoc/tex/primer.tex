...
SVG graphics can be rendered to a canvas using the external JS library \T{canvg.js}\footnote{Developed by Gabe Lerner with contributions to the CSS engine by Rafael Kueng and others.}.
