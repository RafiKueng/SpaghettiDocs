...
%\usepackage[pdfborder=0,pdftex=true]{hyperref}% this enables jumping from a reference and table of content in the pdf file to its target
...
%\end{listing}
%
%\code{test3.js}{This is test 3 . js}
