...
\begin{frame}
  \footnote{Animations: C. Huwyler; gravlens2}
\end{frame}
...
\begin{frame}
  \includegraphics[width=\textwidth]{../../SimAnalysis/text/fig/arriv1}
\end{frame}
\begin{frame}
  \includegraphics[width=\textwidth]{../../SimAnalysis/text/fig/arriv2}
\end{frame}
\begin{frame}
  \includegraphics[width=\textwidth]{../../SimAnalysis/text/fig/arriv3}
\end{frame}


\begin{frame}
  \includegraphics[height=\textheight]{../../SimAnalysis/text/fig/sims/eR_1.pdf}
\end{frame}\begin{frame}
  \includegraphics[height=\textheight]{../../SimAnalysis/text/fig/sims/eR_2.pdf}
\end{frame}\begin{frame}
  \includegraphics[height=\textheight]{../../SimAnalysis/text/fig/sims/eR_3.pdf}
\end{frame}
